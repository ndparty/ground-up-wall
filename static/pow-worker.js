/* PoW solver worker — self-contained (no imports). Mirrors lib/security/sha256.ts + pow.ts. */
"use strict";
...
function hasLeadingZeroBits(hexDigest, bits) {
...
function solvePow(nonce, difficulty, maxIterations) {
...
self.onmessage = function (event) {
  const { nonce, difficulty, maxIterations } = event.data;
  try {
    const solution = solvePow(nonce, difficulty, maxIterations || 5000000);

/**
 * Synchronous SHA-256 (hex). Works without a secure context — required for PoW on HTTP LAN.
 * Same digest as Web Crypto SHA-256 for UTF-8 input strings.
 */
...
export function sha256HexSync(input: string): string {
  ...
  view.setUint32(total - 8, Math.floor(bitLen / 0x1_0000_0000), false);
